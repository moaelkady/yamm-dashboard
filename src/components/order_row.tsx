...
const OrderRow: React.FC<OrderRowProps> = ({ order, handleToggleOrderStatus, handleUpdateOrderDecision }) => {
    const handleStatusToggle = () => handleToggleOrderStatus(order.id, order);
